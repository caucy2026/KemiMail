...
internal fun PermissionsContent(
    ...
    BoxWithConstraints(modifier = modifier.fillMaxSize()) {
        ...
        val isDualScreenCanvas = isSpannedDualScreenCanvas(maxHeight, viewportHeight)

        if (isDualScreenCanvas) {
            Box(
                modifier = Modifier
                    .fillMaxWidth()
        ...
        PermissionsPageContent(
            ...
            onEvent = onEvent,
            brandName = brandName,
            showBrandHeader = !isDualScreenCanvas,
            modifier = if (isDualScreenCanvas) {
                Modifier
                    .fillMaxWidth()
                    .height(viewportHeight)
