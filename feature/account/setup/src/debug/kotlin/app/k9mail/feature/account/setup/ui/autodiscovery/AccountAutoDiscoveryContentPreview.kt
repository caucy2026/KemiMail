...
import app.k9mail.feature.account.setup.ui.credential.fake.FakeRemoteCredentialTransferViewModel
...
internal fun AccountAutoDiscoveryContentPreview() {
    PreviewWithTheme {
        AccountAutoDiscoveryContent(
            ...
            remoteCredentialTransferViewModel = viewModel { FakeRemoteCredentialTransferViewModel() },
            brandName = "BrandName",
