...
class AccountAutoDiscoveryScreenKtTest : ComposeTest() {
    ...
    @Test
    fun `authorization code field should provide acquisition help`() {
        val viewModel = FakeAccountAutoDiscoveryViewModel(
            initialState = State(
                configStep = AccountAutoDiscoveryContract.ConfigStep.PASSWORD,
                emailAddress = StringInputField(value = "user@example.com"),
            ),
        )
        ...
        composeTestRule
            .onNodeWithText(getString(R.string.account_setup_authorization_code_input_label))
            .assertIsDisplayed()
        composeTestRule
            .onNodeWithTag("account_setup_authorization_code_help")
            .performScrollTo()
            .performClick()
        composeTestRule
            .onNodeWithText(getString(R.string.account_setup_authorization_code_help_title))
            .assertIsDisplayed()
        composeTestRule
            .onNodeWithText(getString(R.string.account_setup_authorization_code_help_text))
            .assertIsDisplayed()
    }
