...
class AccountAutoDiscoveryStateMapperKtTest {
    ...
    @Test
    fun `should select password authentication when OAuth discovery falls back to password`() {
        val state = AUTO_DISCOVERY_STATE.copy(
            ...
            autoDiscoverySettings = AUTO_DISCOVERY_STATE.autoDiscoverySettings?.copy(
                incomingServerSettings = (
                    ...
                    authenticationTypes = listOf(
                        AutoDiscoveryAuthenticationType.OAuth2,
                        AutoDiscoveryAuthenticationType.PasswordCleartext,
                    ),
                ),
        ...
        val accountState = state.toAccountState()

        assertThat(accountState.incomingServerSettings?.authenticationType)
            .isEqualTo(AuthType.PLAIN)
        assertThat(accountState.outgoingServerSettings?.authenticationType)
            .isEqualTo(AuthType.PLAIN)
    }
