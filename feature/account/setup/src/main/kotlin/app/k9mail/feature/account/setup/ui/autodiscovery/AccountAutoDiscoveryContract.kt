...
interface AccountAutoDiscoveryContract {
    ...
    interface ViewModel : UnidirectionalViewModel<State, Event, Effect> {
        ...
        val remoteCredentialTransferViewModel: RemoteCredentialTransferContract.ViewModel
    ...
    sealed interface Event {
        ...
        data class OnRemoteCredentialReceived(val credential: String) : Event

        data object OnNextClicked : Event
        data object OnBackClicked : Event
        data object OnRetryClicked : Event
        data object OnEditConfigurationClicked : Event
        data object OnUsePasswordClicked : Event
        data object OnRemoteCredentialTransferClicked : Event
        data object OnRemoteCredentialTransferCanceled : Event
    }
