...
private val MESSAGE_VIEW_OVERFLOW_ACTION_IDS = listOf(
    R.id.move_to_drafts,
    R.id.refile,
    R.id.unsubscribe,
    R.id.show_headers,
...
class MessageViewFragment :
    ...
    private val popupMenuController by lazy {
        AnchoredPopupMenuController(
            fragment = this,
            featureThemeProvider = themeProvider,
        ...
        menuHost.addMenuProvider(
            object : MenuProvider {
                ...
                override fun onPrepareMenu(menu: Menu) {
                    if (!isActive) return
                    prepareMenu(menu)
                    popupMenuController.prepareOverflowMenu(menu, MESSAGE_VIEW_OVERFLOW_ACTION_IDS)
                }
