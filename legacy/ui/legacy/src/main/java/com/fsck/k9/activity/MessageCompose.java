...
public class MessageCompose extends BaseActivity implements OnClickListener,
    ...
    @Override
    protected boolean useAutomaticDualScreenProjection() {
        return false;
    }
    ...
    private final FeatureThemeProvider featureThemeProvider = DI.get(FeatureThemeProvider.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dualScreenComposeController = DualScreenComposeController.create(
                this, displayCoreSettingsPreferenceManager.getConfig().getDualScreenMode(), featureThemeProvider);
        ...
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                if (dualScreenComposeController != null && dualScreenComposeController.handlePopupInteraction(null)) {
                    return;
                }
    ...
    protected void onStart() {
        ...
        if (dualScreenComposeController != null) {
            dualScreenComposeController.setStarted(true);
        }
    }
    ...
    protected void onStop() {
        if (dualScreenComposeController != null) {
            dualScreenComposeController.setStarted(false);
        }
        super.onStop();
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        if (dualScreenComposeController != null) {
            dualScreenComposeController.handlePopupInteraction(event);
        }
    ...
    private void showPopupMenu(View view) {
        ...
        if (!dualScreenComposeController.showPopupMenuIfNeeded(
                view, popup.getMenu(), onMenuItemClickListener)) {
            popup.show();
        }
    }
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        dualScreenComposeController.prepareOptionsMenu(menu, () -> recipientPresenter.onPrepareOptionsMenu(menu));
    ...
    private class MessageComposeMessageLoaderCallback implements MessageLoaderCallbacks {
        ...
        public void onMessageViewInfoLoadFailed(MessageViewInfo messageViewInfo) {
            internalMessageHandler.sendEmptyMessage(MSG_PROGRESS_OFF);
            dualScreenComposeController.showSourceReference(null, action);
            Toast.makeText(MessageCompose.this, R.string.status_invalid_id_error, Toast.LENGTH_LONG).show();
        }
