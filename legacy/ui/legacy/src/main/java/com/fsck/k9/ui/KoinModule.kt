...
import com.fsck.k9.activity.DefaultDualScreenActivityControllerFactory
...
val uiModule = module {
    single<DualScreenActivityControllerFactory> {
        DefaultDualScreenActivityControllerFactory(
            displayCoreSettingsPreferenceManager = get(),
            featureThemeProvider = get(),
        )
    }
    factory {
